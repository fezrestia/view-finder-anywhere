...
internal object PDR2 {
    ...
    /**
     * Get optimal video stream frame size.
     *
     * @param charas Camera characteristics.
     * @return Video stream frame buffer size.
     */
    // TODO: Consider display size ?
    fun getVideoStreamFrameSize(charas: CameraCharacteristics): Size {
        if (Log.IS_DEBUG) Log.logDebug(TAG, "getVideoStreamFrameSize()")
...
//    /**
//     * Get stream surface size for video recording.
//     *
//     * @param videoStreamFrameSize
//     * @param targetAspectWH
//     * @return
//     */
//    fun getVideoSurfaceSize(videoStreamFrameSize: Size, targetAspectWH: Float): Size {
//        if (Log.IS_DEBUG) Log.logDebug(TAG, "getVideoSurfaceStreamSize()")
//
//        val videoW = videoStreamFrameSize.width
//        val videoH = videoStreamFrameSize.height
//        val videoStreamAspectWH: Float = videoW.toFloat() / videoH.toFloat()
//        if (Log.IS_DEBUG) Log.logDebug(TAG, "## VideoSize = $videoW x $videoH")
//
//        var targetW: Int
//        var targetH: Int
//        if (videoStreamAspectWH > targetAspectWH) {
//            // Crop left and right edge.
//            targetW = (videoH * targetAspectWH).toInt()
//            targetH = videoH
//        } else {
//            // Crop top and bottom edge.
//            targetW = videoW
//            targetH = (videoW / targetAspectWH).toInt()
//        }
//        if (Log.IS_DEBUG) Log.logDebug(TAG, "## TargetSize = $targetW x $targetH")
//
//        // Check size is 8-multiple num or not.
//        targetW -= targetW % 8
//        targetH -= targetH % 8
//        if (Log.IS_DEBUG) Log.logDebug(TAG, "## Revised TargetSize = $targetW x $targetH")
//
